...
@section('content')
    ...
    <a href="{{url('admin/hb_cxma/edit')}}" class="btn btn-primary margin-bottom"><i class="fa fa-paint-brush" style="margin-right: 6px"></i>创建</a>
    <div class="box box-primary">
        <div class="col-xs-14 col-sm-14">
            <div class="nav-tabs-custom" id="tabs">
                <ul class="nav nav-tabs sub-nav-tabs">
                    <li role="presentation" class="active"><a href="{{ url("admin/hb_cxma/index")}}">中文版</a></li>
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        @if(count($res)>0)
                            @foreach($res as $v)
                                <tr>
                                    <td>
                                        <a style="font-size: 16px" href="{{ url("/admin/hb_cxma/edit/$v->id") }}"><i class="fa fa-fw fa-pencil" title="修改"></i></a>
