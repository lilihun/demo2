...
@section('content-header')
    {{--<link rel="stylesheet" type="text/css" href="{{ asset("public/lineditor/css/default.css") }}">--}}
    <link rel="stylesheet" type="text/css" href="{{ asset("public/lineditor/css/editor.css") }}">
    {{--<link rel="stylesheet" type="text/css" href="{{ asset("public/dist/plugins/datepicker3.css") }}">--}}
    <h1>
        信息发布管理
        <small>媒体中心</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('/admin/infonews/index')}}">媒体中心管理</a></li>
        <li class="active">编辑媒体中心</li>
    </ol>
@stop
...
@section('content')
    ...
    <form class="form-horizontal" action="{{ url("/admin/infonews/update/$res_jies->news_id") }}" method="post" name="submit1" role="form" id="specification"  data-validate-excluded=":disabled, :not(:visible)" enctype="multipart/form-data">
        {!! csrf_field() !!}
                    ...
                    <div id="floor_1" class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="ht[title]" value="{{ $res_jies->title }}" required class="form-control" maxlength="50">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <textarea name="ht[introduction]" class="form-control" maxlength="150" rows="4">{{ $res_jies->introduction }}</textarea>
                                </div>
                            ...
                            <div class="form-group has-feedback">
                                <label for="" class="col-sm-2 control-label"><span class="txt-required">*</span>媒体图片：</label>
                                <div class="col-sm-10"  style="width: auto">
                                    <div class="multiple-upload pro-thumb" >
                                        @if(!empty($res_jies->pic))
                                            <div class="multiple-item">
                                                ...
                                                <a class="select-image" data-toggle="modal" href="" data-target="#gallery_modal">
                                                    <input type="hidden" name="ht[pic]" value="{{ $res_jies->pic }}">
                                                    <div class="img-put"><img src="{{ $res_jies->pic }}"></div>
                                                </a>
                                            </div>
                                        @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" name="ht[order]" value="{{ $res_jies->order }}"  required  class="form-control" maxlength="5" min="0" placeholder="数值越大，位置越靠前">
                                </div>
                            </div>
                            {{--是否显示--}}
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label  class="form-inline">
                                        <input type="radio" name="ht[disabled]" value='0' @if($res_jies->disabled=='0') checked @endif>
                                        是&nbsp;&nbsp;&nbsp;&nbsp;
                                    </label>
                                    <label  class="form-inline">
                                        <input type="radio" name="ht[disabled]" value='1' @if($res_jies->disabled=='1') checked @endif>
                                        否
                                    </label>
                                </div>
                            </div>
                    ...
                    <div id="floor_2" class="panel panel-default">
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <textarea id="container" name="ht[desc]" class="content">
                                {!! html_entity_decode($res_jies->desc) !!}
                            </textarea>
                        </div>
                    </div>
                    <div class="col-md-2">
    ...
    <form id="uploadForm4" action="{{url("/admin/infonews/create")}}" method="post">
        {{csrf_field()}}
        <input style="display: none;" name="ht[banner]" type="file" class="inputFile" id="inputfile4" />
    </form>
    ...
    <script type="text/javascript">
        $(function (e) {
            $("#uploadForm1").on('submit', function (e) {
                ...
                $.ajax({
                    url: "{{url("/admin/infonews/edit/$res_jies->news_id")}}",
                    type: "POST",
